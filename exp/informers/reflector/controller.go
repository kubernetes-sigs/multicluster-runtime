...
type Config struct {
	...
	// KeyFunction is the function used to generate keys for objects
...
// This controller uses a forked Reflector with cluster-aware key function support.
...
func (c *controller) RunWithContext(ctx context.Context) {
	...
	// Use our Reflector with KeyFunction support
